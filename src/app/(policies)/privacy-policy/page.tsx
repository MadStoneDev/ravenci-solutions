    ...
    <section className={``}>
      ...
      >
        ...
        >
          ...
          <ul className="pl-5">
            <li className="mb-1 list-disc">Device Type</li>
            <li className="mb-1 list-disc">Operating System</li>
            <li className="mb-1 list-disc">Geo-location data</li>
          </ul>
          <p>
          ...
          <p>
            ...
            Australia, and United States, or where we or our partners,
